# 🖼️ Image Picker & Downloader

> Navegue, explore e baixe imagens incríveis — direto do Pexels, sem complicação.
...
A ideia foi consumir a API gratuita do [Pexels](https://www.pexels.com) — um dos maiores bancos de imagens do mundo — e construir uma interface onde fosse possível navegar por imagens, passar para a próxima, voltar para a anterior e baixar a que estiver na tela. Sem cadastro, sem complicação, direto ao ponto.
...
| JavaScript (Vanilla) | Lógica, requisições e interações |
| [Pexels API](https://www.pexels.com/api/) | Fonte das imagens |
...
- Uma chave de API gratuita do Pexels — [clique aqui para criar a sua](https://www.pexels.com/api/)
...
1. Acesse [pexels.com/api](https://www.pexels.com/api/) e crie uma conta gratuita
2. Copie sua chave de API gerada no painel
3. No projeto, localize o arquivo JavaScript principal e substitua o valor da variável da API key pela sua chave
...
- 🐙 **Repositório:** [github.com/1Kronovi1/image-picker-downloader](https://github.com/1Kronovi1/image-picker-downloader/tree/main)
